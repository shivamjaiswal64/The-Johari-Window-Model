...
class JW extends Frame implements ActionListener{
	...
	JW(String fn,int i){		
		this.i = i;
		this.fn = fn;
		this.f = questionChoose(i, fn);
	}
	
	private Frame questionChoose(int i, String fn) {
		Frame f;
		switch(i) { //10 questions with 2 statements
			case 1:	
	...
	//		}
			...
			case 10:
				...
				break;	
			default:
				f = ThanksFrame("Thank you Frame");
		}
		
		return f;
	}
	
	private Frame questionFrame(String fn) {
	...
	private Frame ThanksFrame(String fn){
		Frame f = new Frame(fn);
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==b1){
			...
			dispose();
			 i=i+1;
			new JW("Johari Window Questionnaire "+i,i);
		}
	}
